...
export const buyMenuItems: NavSection[] = [
  ...
  },
  {
    label: "Popular Areas",
    items: [
      { href: "/areas/hivernage", label: "Hivernage" },
      { href: "/areas/gueliz", label: "Gueliz" },
      { href: "/areas/palm-grove", label: "Palm Grove" },
      { href: "/areas/agdal", label: "Agdal" },
    ],
  },
]
...
export const rentMenuItems: NavSection[] = [
  ...
  },
  {
    label: "Popular Areas",
    items: [
      { href: "/rent/areas/hivernage", label: "Hivernage" },
      { href: "/rent/areas/gueliz", label: "Gueliz" },
      { href: "/rent/areas/palm-grove", label: "Palm Grove" },
    ],
  },
]
...
export const featuredProjects: Project[] = [
  ...
  },
  {
    ...
    price: "from MAD 2.9M",
    image:
      "https://images.unsplash.com/photo-1483097365279-e8acd3bf6f08?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  },
]
...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1517841902196-6c0e70e7f9f8?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
