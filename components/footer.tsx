  ...
  return (
    <footer className="bg-white pt-12 md:pt-16 pb-8">
      <div className="max-w-[1170px] mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-12">
          ...
          <div>
            ...
            <div className="space-y-3 sm:space-y-4">
              <a href="tel:+212664722488" className="flex items-center gap-3 text-gray-600 hover:text-primary">
                <Phone className="h-4 w-4 sm:h-5 sm:w-5" />
                <span className="text-sm sm:text-base">06.64.72.24.88</span>
              </a>
              <a href="mailto:Q.huaux@areis.ma" className="flex items-center gap-3 text-gray-600 hover:text-primary">
          ...
          <div>
            ...
            <div className="font-body space-y-3 sm:space-y-4 text-gray-600 text-sm sm:text-base">
        ...
        <div className="border-t pt-6 sm:pt-8 text-center text-xs sm:text-sm text-gray-600 font-body">
